...
func (h *ThreadHandler) DeleteByUser(w http.ResponseWriter, r *http.Request) {
	log := middleware.FromContext(r.Context())
	const op = "thread.handlers.userDelete"
	log = log.With(slog.String("op", op))

	var req dto.DeleteUserThreadRequest
	...
	err = h.service.DeleteByUser(r.Context(), req.BoardKey, req.PostID, req.Password)
